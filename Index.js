...
// Apenas preposicoes compostas e conjuncoes sao ignoradas
// "o" e "a" NAO sao ignorados pois podem ser abreviacoes (ex: "O" de "Oliveira")
...
// MATCHING INTELIGENTE COM ABREVIACOES
// - Tokens de 1-2 letras = abreviacao
// - Tokens de 3+ letras = completo
// - Exige pelo menos 2 tokens completos batendo (ou todos se tiver menos de 2)
// - Abreviacoes so sao aceitas apos minimo de completos batendo
// - Score final: 60% dos tokens precisam ter correspondencia
function nomesBatem(nomePlanilha, nomePDF) {
  ...
  // Sem tokens completos nao da pra identificar com seguranca
  ...
  // Valida abreviacoes — cada abreviacao bate se algum token da planilha comeca com ela
  var matchesAbrev = 0;
